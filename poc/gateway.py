...
CONFIG = {
    ...
    'MAX_AMOUNT': float(os.getenv('MAX_AMOUNT', 100.0)),  # Max ETH per transaction
...
class PaymentGateway:
    ...
    def on_message(self, client, userdata, msg):
        ...
        try:
            ...
            sender = msg.topic  # Use topic as sender identifier
    ...
    async def process_request(self, sender: str, body: str, source: str = 'sms') -> None:
        ...
        try:
            ...
            if source == 'sms':
                ...
                mqtt_client.publish(f"{CONFIG['MQTT_TOPIC']}/response", error_msg)
